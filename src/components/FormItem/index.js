...
export default class FormItem extends PureComponent {
  ...
  InputType = () => {
    ...
    switch (inputType) {
      case "RADIO":
        return this.props.getFieldDecorator(name, {
          ...validateRule,
      ...
      case "DATE":
        return getFieldDecorator(name, {
          rules:
            validateRule && validator
              ? [...validateRule.rules, { validator }]
              : validateRule && [...validateRule.rules],
          initialValue: defaultValue
      ...
      default:
        return getFieldDecorator(name, {
          rules: validateRule && [...validateRule.rules, { type }],
          initialValue: defaultValue
        })(
          <Input
            className={name}
